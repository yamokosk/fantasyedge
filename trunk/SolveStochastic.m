...
%bL = [0, 1, 2, 3, 1, 1, 1, zeros(1,ns), zeros(1,ns)]';
%bU = [100, 1, 2, 3, 1, 1, 1, inf*ones(1,ns), inf*ones(1,ns)]';
...
%      zeros(ns,1), eye(ns,ns), zeros(ns,np)]; % CVaR zk constraints

%f = [1-lambda,  (1-lambda)*inv(1-alpha)*pk', lambda*w_bar'];
